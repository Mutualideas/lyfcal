...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            color_weekday: egui::Color32::from_rgba_unmultiplied(255, 255, 255, 100),
            color_weekday_elapsed: egui::Color32::from_rgba_unmultiplied(255, 255, 255, 20),
            color_weekend: egui::Color32::from_rgba_unmultiplied(225, 225, 250, 100),
            color_weekend_elapsed: egui::Color32::from_rgba_unmultiplied(225, 225, 250, 20),
            color_birthday: egui::Color32::from_rgba_unmultiplied(255, 0, 0, 100),
            color_birthday_elapsed: egui::Color32::from_rgba_unmultiplied(255, 0, 0, 20),
            color_today: egui::Color32::from_rgba_unmultiplied(255, 255, 255, 100),
            unit_ratio: 0.8,
            col_spacing: 1.0,
            row_spacing: 0.0,
            border_spacing: 1.0,
